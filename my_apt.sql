...
CREATE TABLE `tb_assert_operation`  (
  ...
  `operate_key` int(0) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `tb_element`  (
  ...
  `locate_value` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
...
CREATE TABLE `tb_expect_operate_assert`  (
  ...
  `actual` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `description` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `case_id` bigint(0) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `assert_operate_id`(`assert_operate_id`) USING BTREE,
  INDEX `operate_item_id`(`expect`) USING BTREE,
  INDEX `case_id`(`case_id`) USING BTREE,
  ...
  CONSTRAINT `tb_expect_operate_assert_ibfk_2` FOREIGN KEY (`case_id`) REFERENCES `tb_test_cases` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
-- ----------------------------
-- Table structure for tb_operate_result
-- ----------------------------
DROP TABLE IF EXISTS `tb_operate_result`;
CREATE TABLE `tb_operate_result`  (
  `id` int(0) NOT NULL AUTO_INCREMENT,
  `operate_id` bigint(0) NULL DEFAULT NULL,
  `result_key` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `operate_id`(`operate_id`) USING BTREE,
  CONSTRAINT `tb_operate_result_ibfk_1` FOREIGN KEY (`operate_id`) REFERENCES `tb_operate_item` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
